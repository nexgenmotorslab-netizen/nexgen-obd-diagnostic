...
import os
import types
import typing import ModuleTypes
...
if spec is None or spec.loader is None:
    raise ImportError(f"Unable to load scanner module from {scanner_path}")

obd_scanner: types.ModuleType = importlib.util.module_from_spec(spec)
